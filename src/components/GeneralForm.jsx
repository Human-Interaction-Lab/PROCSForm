...
const GeneralForm = ({ onComplete, directoryHandle: initialDirectoryHandle, userId: initialUserId }) => {
  ...
  const [formData, setFormData] = useState({
    question1: '', // In this conversation, it was difficult for me to... engage at a level I felt good about.
    question2: '', // In this conversation, it was difficult for me to... ask questions as desired.
    question3: '', // In this conversation, it was difficult for me to... share my opinion as desired.
    question4: '', // In this conversation, it was difficult for me to... share information as desired.
    question5: '', // In this conversation, it was difficult for me to... keep up with the conversation.
    question6: '', // In this conversation, it was difficult for me to... feel heard by my partner.
    question7: '', // In this conversation, it was difficult for me to... present myself the way I wanted to.
    question8: '', // In this conversation, it was difficult for me to... connect with my partner as desired.
    question9: '', // In this conversation, it was difficult for me to... say what I wanted to say.
    question10: '' // In this conversation, it was difficult for me to... participate.
  });
  ...
  // Check for existing General file if userId and directoryHandle are provided
  useEffect(() => {
    if (initialUserId && initialDirectoryHandle) {
      checkExistingGeneral();
    }
  ...
  const checkExistingGeneral = async () => {
    try {
      const fileName = `${userId}_general.csv`;
  ...
  const saveToCSV = async () => {
    ...
    try {
      ...
      setError('Failed to save general responses');
      return false;
    }
  };
  ...
  const generalQuestions = [
    { id: 'question1', text: 'In this conversation, it was difficult for me to... engage at a level I felt good about.' },
    { id: 'question2', text: 'In this conversation, it was difficult for me to... ask questions as desired.' },
    { id: 'question3', text: 'In this conversation, it was difficult for me to... share my opinion as desired.' },
    { id: 'question4', text: 'In this conversation, it was difficult for me to... share information as desired.' },
    { id: 'question5', text: 'In this conversation, it was difficult for me to... keep up with the conversation.' },
    { id: 'question6', text: 'In this conversation, it was difficult for me to... feel heard by my partner.' },
    { id: 'question7', text: 'In this conversation, it was difficult for me to... present myself the way I wanted to.' },
    { id: 'question8', text: 'In this conversation, it was difficult for me to... connect with my partner as desired.' },
    { id: 'question9', text: 'In this conversation, it was difficult for me to... say what I wanted to say.' },
    { id: 'question10', text: 'In this conversation, it was difficult for me to... participate.' }
  ];
  ...
  if (!showFullForm) {
    return (
      <div className="max-w-2xl mx-auto p-6 space-y-6">
        <h1 className="text-2xl font-bold mb-6">Communication Assessment - General</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-gray-100 p-6 rounded-lg">
          ...
          <p className="text-sm text-gray-700 mb-6">
            Please rate how much you agree or disagree with each statement about this conversation.
          </p>
